...
class Boundary():
    ...
    def __init__(self, BCtype=None, BCvalueface = None, BCvaluenode = None, BCvaluehalo = None, 
        ...
        if self._BCtype == "neumann" or self._BCtype == "periodic":
           ...
           self._func_ghost_args.extend([self.BCvalueface, self.domain.faces.normal, self.domain.faces.mesure])
           self._func_haloghost_args.extend([self.BCvaluehalo, self.domain.nodes.ghostfaceinfo])
