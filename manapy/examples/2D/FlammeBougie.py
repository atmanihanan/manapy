...
from manapy.solvers.combustion.tools_utils import initialisation_Bougie, ghost_value_Bougie,haloghost_value_Bougie
...
initialisation_Bougie(rho.cell, rhou.cell, rhov.cell, rhoE.cell,e_internal.cell, 
                    P.cell,T.cell,Y1.cell, Y2.cell, rhoY1.cell, rhoY2.cell , cells.center, gamma=1.4, R_gaz=R_gaz)
...
while time < tfinal:
    ...
    ghost_value_Bougie(rho.ghost,P.ghost,rhou.ghost,rhov.ghost,
                    ...
                    Y1.cell,Y2.cell,domain.faces.cellid,
                    domain.faces.ghostcenter,faces_in,faces_out,faces_upper,faces_bottom, R_gaz,T_in, U_in)
#cell
    haloghost_value_Bougie(rho.halo,rhou.halo, rhov.halo, rhoE.halo, P.halo, T.halo,rhoY1.halo,rhoY2.halo, Y1.halo,Y2.halo, 
                            ...
                            ,domain.nodes.haloghostcenter, domain.halonodes, domain.cells.haloghostcenter, R_gaz,T_in, U_in)
