...
from manapy.solvers.diffusion.tools_utils import initialisation_gaussian_2d
...
conf = Struct(Dxx=.1, Dyy=0., order=2, cfl=0.8)
S = DiffusionSolver(ne, vel=(u, v), conf=conf)
