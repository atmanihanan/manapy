...
from manapy.solvers.Euler.tools_utils import initialisation_tubeChok4, initialisation_tubeChok4exac,Exact_Euler, step,ghost_value_test,compute_p,haloghost_value_test,norml2
...
faces_bottom = domain.get_bottom_faces()
faces_upper = domain.get_upper_faces()
faces_in = domain.get_in_faces()
faces_out = domain.get_out_faces()
...
initialisation_tubeChok4(rho.cell, rhou.cell, rhov.cell, rhoE.cell,e_internal.cell, P.cell, cells.center, gamma=1.4)
...
initialisation_tubeChok4exac(rho_exact.cell, u_exact.cell, E_exact.cell,e_internal_exact.cell, P_exact.cell, cells.center, gamma=1.4)
...
if RANK==0:
    ...
    def save_results(nbcells, h, Error_rho, Error_rhou, Error_rhoE, Error_p, ordre, CPU_time, filename="results4.csv"):
        """
