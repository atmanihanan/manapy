...
from manapy.solvers.Euler.tools_utils import initialisation_tubeChok3, initialisation_tubeChok3exac, Exact_Euler, step, compute_p, ghost_value_test,Exact_Euler,haloghost_value_test,norml2
...
initialisation_tubeChok3(rho.cell, rhou.cell, rhov.cell, rhoE.cell,e_internal.cell, P.cell, cells.center, gamma=1.4)
...
initialisation_tubeChok3exac(rho_exact.cell, u_exact.cell, E_exact.cell,e_internal_exact.cell, P_exact.cell, cells.center, gamma=1.4)
...
if RANK==0:
    ...
    def save_results(nbcells, h, Error_rho, Error_rhou, Error_rhoE, Error_p, ordre, CPU_time, filename="results3.csv"):
        """
